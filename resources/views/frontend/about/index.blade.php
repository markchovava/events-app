...
@section('frontend.master')
    ...
    <section class="breadcrumb-area bg-img bg-gradient-overlay jarallax" style="background-image: url(__assets/confer/img/img/bg-img/27.jpg);">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-we-offer-content text-center wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="offer-icon">
                            <img src="./__assets/confer/img/core-img/icon.png" alt="">
                        </div>
                        <h5>Conference</h5>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-we-offer-content text-center wow fadeInUp" data-wow-delay="0.3s">
                        <!-- Icon -->
                        <div class="offer-icon">
                            <img src="./__assets/confer/img/core-img/icon-2.png" alt="">
                        </div>
                        <h5>Workshops</h5>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-we-offer-content text-center wow fadeInUp" data-wow-delay="0.3s">
                        <!-- Icon -->
                        <div class="offer-icon">
                            <img src="./__assets/confer/img/core-img/icon-3.png" alt="">
                        </div>
                        <h5>Coffee Breaks</h5>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-we-offer-content text-center wow fadeInUp" data-wow-delay="0.3s">
                        <!-- Icon -->
                        <div class="offer-icon">
                            <img src="./__assets/confer/img/core-img/icon-4.png" alt="">
                        </div>
                        <h5>Events</h5>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="about-thumb mb-80 wow fadeInUp" data-wow-delay="300ms">
                        <img src="./__assets/confer/img/bg-img/2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="speaker-single-thumb">
                            <img src="./__assets/confer/img/bg-img/4.jpg" alt="">
                        </div>
                        <!-- Social Info -->
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="./__assets/confer/img/bg-img/5.jpg" alt="">
                        </div>
                        <!-- Social Info -->
                        <div class="social-info">
                            <a href="#"><i class="zmdi zmdi-facebook"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="./__assets/confer/img/bg-img/6.jpg" alt="">
                        </div>
                        <!-- Social Info -->
                        <div class="social-info">
                            <a href="#"><i class="zmdi zmdi-facebook"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="./__assets/confer/img/bg-img/7.jpg" alt="">
                        </div>
                        <!-- Social Info -->
                        <div class="social-info">
                            <a href="#"><i class="zmdi zmdi-facebook"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="./__assets/confer/img/bg-img/8.jpg" alt="">
                        </div>
                        <!-- Social Info -->
                        <div class="social-info">
                            <a href="#"><i class="zmdi zmdi-facebook"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="./__assets/confer/img/bg-img/9.jpg" alt="">
                        </div>
                        <!-- Social Info -->
                        <div class="social-info">
                            <a href="#"><i class="zmdi zmdi-facebook"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-3">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="./__assets/confer/img/bg-img/28.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-3">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="./__assets/confer/img/bg-img/29.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="./__assets/confer/img/bg-img/30.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="./__assets/confer/img/bg-img/31.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-3">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="./__assets/confer/img/bg-img/32.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-3">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="./__assets/confer/img/bg-img/33.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="single-client-text about-page">
                                ...
                                <div class="single-client-thumb-info d-flex align-items-center">
                                    ...
                                    <div class="single-client-thumb">
                                        <img src="./__assets/confer/img/bg-img/15.jpg" alt="">
                                    </div>
                                    <!-- Info -->
                        ...
                        <div class="single-client-content bg-boxshadow wow fadeInUp" data-wow-delay="300ms">
                            <div class="single-client-text about-page">
                                ...
                                <div class="single-client-thumb-info d-flex align-items-center">
                                    <!-- Thumb -->
                                    <div class="single-client-thumb">
                                        <img src="./__assets/confer/img/bg-img/16.jpg" alt="">
                                    </div>
                                    <!-- Info -->
                                    <div class="client-info">

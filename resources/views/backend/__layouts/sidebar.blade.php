        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div data-kt-menu-trigger="click" 
                    class="menu-item menu-accordion {{ $active == 'Users' || $active == 'Clients' ? 'show active' : ''}}">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <!-- Teachers -->
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ $active == 'Users' ? 'show' : ''}}">
                            <span class="menu-link">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('admin.user.add') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                ...
                <!-- Events -->
                <div data-kt-menu-trigger="click" 
                    class="menu-item menu-accordion {{ $active == 'Events' ? 'show active' : ''}}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                            <span class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                                ...
                                <span class="menu-title">Daily Events</span>
                            </a>
                        </div>
                        <!--:: End ::-->
                        <!--:: Start ::-->
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                                ...
                                <span class="menu-title">Monthly Events</span>
                            </a>
                        </div>
                        <!--:: End ::-->
                        <!--:: Start ::-->
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link" href="">
                                        ...
                                        <span class="menu-title">View Info</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="">
                                        ...
                                        <span class="menu-title">Edit Info</span>
                                    </a>
                                </div>
                            </div>
                        </div>

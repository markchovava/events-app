        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form method="POST" action="{{ route('admin.staff.update', $user->id) }}" enctype="multipart/form-data" class="form">
                        @csrf
                        <!-- Role -->
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    ...
                                    data-placeholder="Select an Option." class="form-select form-select-solid form-select-lg">
                                        <option value="">Select an Option.</option>
                                        <option value="Married" {{ $user->staff->marital_status == 'Married' ? 'selected="selected"' : '' }}>Married</option>
                                        <option value="Single" {{ $user->staff->marital_status == 'Single' ? 'selected="selected"' : '' }}>Single</option>
                                        <option value="Other" {{ $user->staff->marital_status == 'Other' ? 'selected="selected"' : '' }}>Other</option>
                                    </select>
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row d-flex">
                                    ...
                                    placeholder="Eg. Bachelor of Arts in ....">{{ $user->staff->qualification }}</textarea>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row d-flex">
                                    ...
                                    placeholder="Eg. 5 years experence in ....">{{ $user->staff->experience }}</textarea>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row d-flex">
                                     ...
                                     value="{{ $user->staff->next_of_kin }}" placeholder="Next of Kin..." />
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
                            </div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 fv-row">
                                            ...
                                            value="{{ $user->staff->first_name }}" placeholder="Your First Name...." />
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-lg-6 fv-row">
                                            <input type="text" name="kin_last_name" class="form-control form-control-lg form-control-solid" 
                                            value="{{ $user->staff->last_name }}" placeholder="Your Last Name..." />
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Row-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    ...
                                    value="{{ $user->staff->phone }}" placeholder="+263 (0) 782 123123" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    ...
                                    value="{{ $user->staff->email }}"placeholder="abc@example.com" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row d-flex">
                                    ...
                                    placeholder="12, First Street, Avonlea, Harare">{{ $user->staff->address }}</textarea>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    ...
                                    value="{{ $user->staff->occupation }}" placeholder="Managing Director" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                             ...
                             <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    ...
                                    value="{{ $user->staff->company_name }}" placeholder="Old Mutual" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
